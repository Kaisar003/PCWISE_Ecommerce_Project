        ...
        <>
            ...
            <section className="bg-white dark:bg-gray-900 px-10">
                <div className="flex justify-center bg-blue-linear-gradient shadow-md rounded-3xl max-w-5xl m-auto mt-6 mb-24">
                    <div className="p-8 flex items-center gap-x-28">
                        <div className="block">
                            <h2 className="mb-5 text-4xl font-bold text-text-alternative md:mb-6 md:text-5xl lg:text-6xl">
                                Contact us
                            </h2>
                            <p className="text-base text-text-alternative md:text-md">Feel free to reach out us</p>
                        </div>
                        <img src="./chat.png" className="w-60" alt="Image of PC" />
                    </div>
                </div>
